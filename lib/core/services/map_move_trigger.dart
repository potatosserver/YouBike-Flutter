...
class MapMoveTrigger extends ChangeNotifier {
  ...
  void setAnimatedMap(AnimatedMapController animatedMap) {
    _animatedMap = animatedMap;
    notifyListeners();
  }

  AnimatedMapController? get animatedMap => _animatedMap;
